...
(function () {
  ...
  (b = "0.8.5"),
      ...
      (e =
          ("undefined" != typeof localStorage && null !== localStorage ? localStorage.getItem : void 0) && localStorage.getItem("wit_debug")
              ? function () {
      ...
      (c = localStorage.getItem("wit_ws") || "wss://ws.wit.ai/speech_ws"),
      (a = function (a) {
          var b, c;
          return (
              (this.conn = null),
              ...
              (this.handleResult = function (a) {
                  var b, c, d, e, f;
                  return _.isFunction((c = this.onresult)) ? ((d = null != (e = a.outcome) ? e.intent : void 0), (b = null != (f = a.outcome) ? f.entities : void 0), c.call(window, d, b, a)) : void 0;
              }),
              a &&
                  ((this.elem = a),
                  (a.innerHTML = "<div class='mic mic-box icon-wit-mic'>\n</div>\n<svg class='mic-svg mic-box'>\n</svg>"),
                  (a.className += " wit-microphone"),
                  a.addEventListener(
                      "click",
                      (function (a) {
                          return function (b) {
                  ...
                  return (
                      ...
                      this.elem
                          ? ((i = getComputedStyle(c)),
                            ...
                            (f = parseInt(i.height, 10)),
                            (b = "border-box" === i.boxSizing ? parseInt(i.borderTopWidth, 10) : 0),
                            (g = l / 2 - b - 5),
                            (a = 1e3),
                            (d = l / 2 - b),
                            (e = f / 2 - b - g),
                            (m = 0),
                            (j = 1),
                            (h = (null != (n = window.performance) ? n.now() : void 0) || new Date()),
                            (k = (function (c) {
                                return function (i) {
                                    var n, o, p, q;
                                    return (
                                        (o = (((i - h) % a) / a) * 2 * Math.PI - Math.PI / 2),
                                        (p = Math.cos(o) * g + l / 2 - b),
                                        (q = Math.sin(o) * g + f / 2 - b),
                                        (n = +(1.5 * Math.PI > o && o > Math.PI / 2)),
                                        c.path.setAttribute("d", "M" + d + "," + e + "A" + g + "," + g + "," + m + "," + n + "," + j + "," + p + "," + q),
                                        c.thinking ? requestAnimationFrame(k) : (c.elem.classList.remove("thinking"), c.path.setAttribute("d", "M0,0"))
                                    );
                                };
                            })(this)),
      ...
      (f = {
          disconnected: {
              connect: function (a, b) {
                  var d, f;
                  return (
                      a || this.handleError("No token provided"),
                      (d = new WebSocket(c)),
                      (d.onopen = (function (c) {
                          return function (c) {
                              var f;
                              return e("connection opened", c), (f = { token: a, bps: 16, encoding: "signed-integer", version: b || 20130816 }), d.send(JSON.stringify(["auth", f]));
                          };
                      })(this)),
                      ...
                      (f = (function (a) {
                          return function (b) {
                              ...
                              return (
                                  (c = a.ctx),
                                  (f = c.createMediaStreamSource(b)),
                                  (d = (c.createScriptProcessor || c.createJavascriptNode).call(c, 4096, 1, 1)),
                                  (d.onaudioprocess = function (b) {
                                      var c, d, f, g, h, i, j, k;
                                      if (a.rec) {
                      ...
                      navigator.mediaDevices.getUserMedia({ audio: !0 }).then(f).catch(this.handleError),
                      "connecting"
                  );
              },
          },
          ...
          ready: {
              ...
              toggle_record: function () {
                  return (
                      this.ctx || console.error("No context"),
                      this.stream || console.error("No stream"),
                      this.src || console.error("No source"),
      ...
      (a.prototype.fsm = function (a) {
          ...
          if (((c = null != (g = f[this.state]) ? g[a] : void 0), (b = Array.prototype.slice.call(arguments, 1)), _.isFunction(c)))
              switch (
                  ((d = c.apply(this, b)),
                  e("fsm: " + this.state + " + " + a + " -> " + d, b),
                  (this.state = d),
                  ("audiostart" === d || "audioend" === d || "ready" === d || "connecting" === d || "disconnected" === d) && _.isFunction((c = this["on" + d])) && c.call(window),
                  d)
              ) {
                  case "disconnected":
